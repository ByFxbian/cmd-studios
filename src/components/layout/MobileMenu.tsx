    ...
    <AnimatePresence>
      {isOpen && (
        <div className="md:hidden">
          {/* A. Hintergrund mit Links (z-80) */}
          <motion.div
            className="fixed top-0 left-0 w-full h-screen bg-zinc-900 z-[80] flex items-center justify-center"
          ...
          {/* B. Die animierten Vorhänge (z-81, z-82) */}
          <motion.div
            className="fixed top-0 left-0 w-full h-screen bg-accent z-[82]"
            custom="top" // Startet/endet oben
            initial="closed"
            animate="open"
            exit="closed"
            variants={curtainVariants1}
          />
          <motion.div
            className="fixed top-0 left-0 w-full h-screen bg-zinc-900 z-[81]"
            custom="top" // Startet/endet oben
            initial="closed"
            animate="open"
            exit="closed"
            variants={curtainVariants2}
