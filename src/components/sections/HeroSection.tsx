...
export function HeroSection() {
    ...
    return (
        <section ref={sectionRef} className='relative h-screen w-full overflow-hidden bg-[var(--color-page-bg)]'>
            ...
            <div className="absolute bottom-0 left-0 w-full h-64 bg-gradient-to-t from-[var(--color-page-bg)] to-transparent z-[1]" />
            ...
            <div className="relative z-10 h-full w-full container mx-auto px-6 grid grid-cols-12 grid-rows-6 pt-24 pb-12 pointer-events-none">
                ...
                <motion.div 
                    className="col-span-12 md:col-span-5 row-start-5 row-span-2 flex flex-col justify-end pb-8"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    transition={{ duration: 1, delay: 0.4 }}
                >
                    <p className="text-xl md:text-2xl text-[var(--color-text)] mb-8 leading-relaxed max-w-md pointer-events-auto">
                    ...
                    <div className="flex gap-6 pointer-events-auto">
                        <MagneticLink 
                            href="/portfolio"
                            className="group relative px-8 py-4 bg-[var(--color-heading)] text-[var(--color-page-bg)] rounded-full overflow-hidden"
                        >
                        ...
                        <MagneticLink 
                             href="/contact"
                             className="px-8 py-4 border border-[var(--color-text-muted)] rounded-full hover:bg-[var(--color-heading)] hover:text-[var(--color-page-bg)] transition-all duration-300"
                        >
                            Kontakt
                        </MagneticLink>
                    </div>
                ...
                <motion.div className="flex gap-4" variants={itemVariants}>
                    ...
                    <MagneticLink 
                        ...
                        className="bg-transparent border border-zinc-300 text-zinc-700 font-semibold px-6 py-3 rounded-md 
                                   ...
                                   dark:border-zinc-700 dark:text-zinc-700 dark:hover:bg-zinc-800 dark:hover:text-zinc-300"
                    >
                        Kontakt
                    </MagneticLink>
                </motion.div>
